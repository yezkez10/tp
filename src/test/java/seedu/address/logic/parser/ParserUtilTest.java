...
public class ParserUtilTest {
    ...
    private static final String INVALID_GENDER = "S";
    private static final int INVALID_AGE = 200;
    private static final String INVALID_ETHNICITY = "minion";
    private static final String INVALID_NRIC = "X9876543B";
    ...
    private static final String VALID_ETHNICITY = "Eurasian";
    private static final String VALID_NRIC = "S9876543B";
    private static final String VALID_TAG_1 = "type 1 diabetes";
    private static final String VALID_TAG_2 = "smoker";
    ...
    public void parseAge_invalidValue_throwsParseException() {
        assertThrows(ParseException.class, () -> ParserUtil.parseAge(String.valueOf(INVALID_AGE)));
    }

    @Test
    public void parseAge_validValueWithoutWhitespace_returnsAge() throws Exception {
        Age expectedAge = new Age(VALID_AGE);
        assertEquals(expectedAge, ParserUtil.parseAge(String.valueOf(VALID_AGE)));
    }

    @Test
    public void parseAge_validValueWithWhitespace_returnsTrimmedGender() throws Exception {
        String ageWithWhitespace = WHITESPACE + VALID_AGE + WHITESPACE;
        Age expectedAge = new Age(VALID_AGE);
        assertEquals(expectedAge, ParserUtil.parseAge(ageWithWhitespace));
    }
    @Test
    public void parseEthnicity_null_throwsNullPointerException() {
        assertThrows(NullPointerException.class, () -> ParserUtil.parseEmail((String) null));
    }

    @Test
    public void parseEthnicity_invalidValue_throwsParseException() {
        assertThrows(ParseException.class, () -> ParserUtil.parseEmail(INVALID_EMAIL));
    }

    @Test
    public void parseEthnicity_validValueWithoutWhitespace_returnsEthnicity() throws Exception {
        Ethnicity expectedEthnicity = new Ethnicity(VALID_ETHNICITY);
        assertEquals(expectedEthnicity, ParserUtil.parseEthnic(VALID_ETHNICITY));
    }

    @Test
    public void parseEthnicity_validValueWithWhitespace_returnsTrimmedEthnicity() throws Exception {
        String ethnicityWithWhitespace = WHITESPACE + VALID_ETHNICITY + WHITESPACE;
        Ethnicity expectedEthnicity = new Ethnicity(VALID_ETHNICITY);
        assertEquals(expectedEthnicity, ParserUtil.parseEthnic(ethnicityWithWhitespace));
    }
    @Test
    ...
    @Test
    public void parseNric_validValueWithoutWhitespace_returnsEmail() throws Exception {
        Nric expectedNric = new Nric(VALID_NRIC);
        assertEquals(expectedNric, ParserUtil.parseNric(VALID_NRIC));
    }

    @Test
    public void parseNric_validValueWithWhitespace_returnsTrimmedEmail() throws Exception {
