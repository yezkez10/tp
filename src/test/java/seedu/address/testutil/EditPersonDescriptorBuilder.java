...
public class EditPersonDescriptorBuilder {
    ...
    public EditPersonDescriptorBuilder(Person person) {
        ...
        descriptor.setEthnic(person.getEthnic());
    ...
    /**
     * Sets the {@code Ethnicity} of the {@code EditPersonDescriptor} that we are building.
     */
    public EditPersonDescriptorBuilder withEthnic(String ethnic) {
        descriptor.setEthnic(new Ethnicity(ethnic));
        return this;
    }
    /**
