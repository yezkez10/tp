...
public class PersonUtil {
    ...
    public static String getPersonDetails(Person person) {
        ...
        sb.append(PREFIX_AGE + person.getAge().toString() + " ");
        sb.append(PREFIX_ETHNIC + person.getEthnic().ethnic + " ");
    ...
    public static String getEditPersonDescriptorDetails(EditPersonDescriptor descriptor) {
        ...
        descriptor.getAge().ifPresent(age -> sb.append(PREFIX_AGE).append(age).append(" "));
        descriptor.getEthnic().ifPresent(ethnicity -> sb.append(PREFIX_ETHNIC).append(ethnicity.ethnic).append(" "));
