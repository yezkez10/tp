...
public class JsonAdaptedPersonTest {
    ...
    private static final String[] INVALID_APPOINTMENT = new String[]{"hii", "2019 01 01"};
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_NRIC,
                        VALID_ADDRESS, VALID_TAGS, VALID_APPOINTMENT);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_NRIC,
                        INVALID_ADDRESS, VALID_TAGS, VALID_APPOINTMENT);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_NRIC,
                null, VALID_TAGS, VALID_APPOINTMENT);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_NRIC,
                        VALID_ADDRESS, invalidTags, VALID_APPOINTMENT);
    ...
    public void toModelType_invalidAppointments_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_NRIC,
                        VALID_ADDRESS, VALID_TAGS, invalidAppointments);
        assertThrows(IllegalValueException.class, person::toModelType);
    }
