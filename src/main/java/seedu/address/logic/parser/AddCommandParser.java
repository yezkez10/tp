...
public class AddCommandParser implements Parser<AddCommand> {
    ...
    //TODO: edit parser to fit our UG requirements
    /**
    ...
    public AddCommand parse(String args) throws ParseException {
        ...
        argMultimap.verifyNoDuplicatePrefixesFor(PREFIX_NAME, PREFIX_PHONE, PREFIX_EMAIL, PREFIX_GENDER, PREFIX_AGE,
                PREFIX_ETHNIC, PREFIX_NRIC, PREFIX_ADDRESS);
        ...
        Ethnicity ethnicity = ParserUtil.parseEthnic(argMultimap.getValue(PREFIX_ETHNIC).get());
        Address address = ParserUtil.parseAddress(argMultimap.getValue(PREFIX_ADDRESS).get());
        Set<Tag> tagList = ParserUtil.parseTags(argMultimap.getAllValues(PREFIX_TAG));

        Person person = new Person(name, phone, email, gender, age, ethnicity, nric, address, tagList);
